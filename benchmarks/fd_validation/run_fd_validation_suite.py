...
Analytic-vs-FD internal consistency, made systematic.  For each FCI-accessible
...
read straight from JSONL and a reader can see at a glance whether a point is
