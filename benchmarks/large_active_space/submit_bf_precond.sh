...
#SBATCH -t 36:00:00
#SBATCH --array=0-1
#SBATCH -o /n/home04/yulili/daisuan/dmrg_sacasscf_response_public/slurm_bfprecond_%A_%a.out
#SBATCH -e /n/home04/yulili/daisuan/dmrg_sacasscf_response_public/slurm_bfprecond_%A_%a.err
set -euo pipefail
...
SCR=/n/netscratch/woo_lab/Lab/yulili/bfprecond/c${N}; mkdir -p $SCR
...
echo "bfprecond C${N} start $(date) host $(hostname)"
