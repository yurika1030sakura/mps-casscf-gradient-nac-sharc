"""Finite-difference validation on N2 and LiF (the artifacts this study needs).

The original HeH+ suite (test_fd_validation.py) is the only committed FD-validation
artifact.  The manuscript references N2 gradient and LiF NAC accuracies that had
...
the same three checks as HeH+:
  ...
  C2  central-difference gradient vs analytic       -- central finite-difference check
  C3  cross-geometry overlap FD NAC vs analytic     -- cross-geometry overlap check
